...
- do not confuse props with clothing, armor, anatomy, or identity-defining traits`,
  THREED_REMOVE_ACCESSORIES_STYLE_IMAGE1:                     PLACEHOLDER,
  THREED_KEEP_ACCESSORIES_STYLE_IMAGE2:                       PLACEHOLDER,
  THREED_REMOVE_ACCESSORIES_STYLE_IMAGE2:                     PLACEHOLDER,

  // --- Casos manuais (preset principal) ---
  THREED_MANUAL_CUTE_TOY_PREMIUM_MATTE_PRINT_KEEP_ACCESSORIES:    PLACEHOLDER,
  THREED_MANUAL_CUTE_TOY_PREMIUM_MATTE_PRINT_REMOVE_ACCESSORIES:  PLACEHOLDER,
  THREED_MANUAL_CHIBI_CUTE_TOY_MATTE_KEEP_ACCESSORIES:            PLACEHOLDER,
  THREED_MANUAL_CHIBI_CUTE_TOY_MATTE_REMOVE_ACCESSORIES:          PLACEHOLDER,
