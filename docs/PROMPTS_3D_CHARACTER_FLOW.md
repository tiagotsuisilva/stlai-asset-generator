...
> Status: 1/12 prompts definitivos preenchidos (`THREED_KEEP_ACCESSORIES_STYLE_IMAGE1`). 11 ainda em placeholder.
...
| `THREED_REMOVE_ACCESSORIES_STYLE_IMAGE1` | Estilo da Imagem 1 sem acessórios | `accessoriesMode=remove`, `styleSource=image1` | ⏳ placeholder |
| `THREED_KEEP_ACCESSORIES_STYLE_IMAGE2` | Estilo da Imagem 2 com acessórios preservados | `accessoriesMode=keep`, `styleSource=image2` | ⏳ placeholder |
...
Descrição:
Remove acessórios não-essenciais da imagem 2, usa estrutura/pose/proporções da imagem 1 e mantém estilo visual da imagem 1.
...
Descrição:
Preserva eventuais acessórios da imagem 2, usa estrutura/pose/proporções da imagem 1 e adota o estilo visual da imagem 2.
