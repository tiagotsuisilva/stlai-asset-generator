...
> Status: 10/12 prompts definitivos preenchidos — todos os 4 casos com estilo da imagem + par cute toy premium + par chibi cute toy + par semi-realistic statue resin (keep + remove). Faltam 2 presets manuais (realistic painted resin keep/remove).
