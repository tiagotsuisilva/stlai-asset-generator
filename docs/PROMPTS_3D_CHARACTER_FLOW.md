...
> Status: 8/12 prompts definitivos preenchidos — todos os 4 casos com estilo da imagem + par cute toy premium + par chibi cute toy (keep + remove). Faltam 4 presets manuais.
